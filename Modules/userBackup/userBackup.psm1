function New-Backup {
    ...
    $StagingLogPath = "$env:TEMP\{0}_staging.log" -f (Get-Date -Format 'yyyyMMddHHmmss');
    ...
    $RobocopyLogPath = "$env:TEMP\{0}_copy.log" -f (Get-Date -Format 'yyyyMMddHHmmss');
...
New-Backup -Source "$env:APPDATA\Microsoft\Signatures" -Destination "$env:OneDrive\Backup\Signatures" -Verbose;